  ...
  return (
    <div className="relative z-50 flex items-center justify-between gap-3 bg-amber-400 px-4 py-2.5 text-amber-950">
      ...
      <div className="relative flex shrink-0 items-center gap-2">
        <Link
          to="/cadastro"
          className="inline-flex items-center gap-1.5 rounded-lg bg-amber-950 px-3 py-1.5 text-xs font-bold text-amber-100 transition hover:bg-amber-900"
        >
          Criar conta grátis
        ...
        <button
          onClick={handleExit}
          className="flex h-7 w-7 items-center justify-center rounded-lg transition hover:bg-amber-500"
